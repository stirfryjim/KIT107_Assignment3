...
{	
	...
	*/
	public Square(Location l)
	{
		...
		//stores location and a new default symbol
		this.loc = l;
	...
	*/
	public Object clone()
	{
		...
		// assigns the new square the parameters 
	...
	*/
	public boolean isEmpty()
	{
		...
		// returns if square doesnt contain a symbol
	...
	*/
	public void showSquare(Display s,int w)
	{
		...
		symbol.showSymbol(s,loc,w);
      	...
      	trace("showSquare: toString ends");
	}
